...
final class NowPlayingCompactPageController: UIViewController {
    ...
    private lazy var centerSectionView = NowPlayingCenterSectionView(transportView: compactTransportView)
    ...
    var onSeekToLyricsTime: (TimeInterval) -> Void = { _ in } {
        didSet {
    ...
    var onManageLyrics: (_ lyrics: [String], _ activeIndex: Int?) -> Void = { _, _ in } {
        didSet {
...
extension NowPlayingCompactPageController: UIScrollViewDelegate {
