...
class NowPlayingViewController: UIViewController {
    ...
    let pageViewController = NowPlayingPageViewController()
    let controlIslandViewModel = NowPlayingControlIslandViewModel()
    let routePickerPresenter = NowPlayingRoutePickerPresenter()
    var playbackSnapshotCancellable: AnyCancellable?
    var playbackProgressCancellable: AnyCancellable?
    var queueSnapshotCancellable: AnyCancellable?
    var contentSelectorCancellable: AnyCancellable?
    ...
    var lastBackgroundSource: NowPlayingControlIslandViewModel.BackgroundSource?
    ...
    var lyricsChineseConvertCancellable: AnyCancellable?
    ...
    deinit {
        playbackSnapshotCancellable?.cancel()
        playbackProgressCancellable?.cancel()
        queueSnapshotCancellable?.cancel()
        contentSelectorCancellable?.cancel()
        lyricsChineseConvertCancellable?.cancel()
    ...
    func bindLyricsChineseConvertPreference() {
        lyricsChineseConvertCancellable = ConfigurableKit.publisher(
    ...
    private func installPageViewController() {
        ...
        pageViewController.onCopyAllLyrics = { lyrics in
            ...
            AppLog.info("NowPlayingViewController", "copyAllLyrics count=\(lyrics.count)")
