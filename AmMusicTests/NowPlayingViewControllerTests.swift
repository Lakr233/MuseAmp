...
@Suite(.serialized)
@MainActor
struct NowPlayingViewControllerTests {
    @Test("Now playing updates presentation state when track changes out of order")
    func refreshesArtworkWhenTrackChangesOutOfOrder() throws {
