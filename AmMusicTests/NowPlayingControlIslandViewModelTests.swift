...
struct NowPlayingControlIslandViewModelTests {
    @Test("Control island shows AirPods Pro symbol for AirPods Pro routes")
    func showsAirPodsProSymbol() {
    ...
    @Test("Control island shows speaker symbol for built-in speaker")
    func showsBuiltInSpeakerSymbol() {
        let viewModel = NowPlayingControlIslandViewModel()
        let snapshot = makeSnapshot(
    ...
    @Test("Control island shows TV symbol for Apple TV AirPlay routes")
    func showsTelevisionSymbolForAirPlayTV() {
        let viewModel = NowPlayingControlIslandViewModel()
        let snapshot = makeSnapshot(
