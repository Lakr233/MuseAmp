...
struct DatabaseCRUDTests {
    @Test("Database tables support full CRUD")
    func databaseCRUD() async throws {
    ...
    @Test("Database groups tracks into local albums")
    func groupsTracksIntoAlbums() async throws {
